...
/*=======================================================================================================Sending Data Over the Network==============================================================================================================================*/
          ...
          packet << goodInput; // Puts coordinates into the packet.
          socket.send(packet); // Sends packet

          socket.receive(packet); // Client recieves the packet with data
          if (packet >> goodInput){ // Check for data in the packet. Same order as data was put into the packet
